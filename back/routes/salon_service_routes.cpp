...
void GetSalonServicesRoute(expresso::messages::Request  &req,
  ...
  try {
    auto services = SalonServiceContext::salonServiceRepo->getAllServices();
...
void PostSalonServiceRoute(expresso::messages::Request  &req,
  ...
  try {
    ...
    if (body.find("name") == body.end()) {
      ...
      return res.status(expresso::enums::STATUS_CODE::BAD_REQUEST).json(err).end();
    }
    ...
    SalonServiceContext::salonServiceRepo->addService(name, duration, price);
...
void PutSalonServiceRoute(expresso::messages::Request  &req,
  ...
  try {
    ...
    SalonServiceContext::salonServiceRepo->updateService(id, req.body);
...
void DeleteSalonServiceRoute(expresso::messages::Request  &req,
  ...
  try {
    ...
    int id = std::stoi(idStr);
    SalonServiceContext::salonServiceRepo->deleteService(id);
...
void PutResourceServicesRoute(expresso::messages::Request  &req,
  ...
  try {
    ...
    SalonServiceContext::salonServiceRepo->setServicesForResource(resource_id,
                                                                  service_ids);
